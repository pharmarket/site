...
(function ($) {
    ...
    var feature = {};
    feature.fileapi = $("<input type='file'  onclick='checkId(this)'/>").get(0).files !== undefined;
    ...
    $.fn.uploadFile = function (options) {
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input type='file' id='" + fileUploadId + "' onclick='checkId(this)' name='" + s.fileName + "'/>";
            if (s.multiple) {
                if (s.fileName.indexOf("[]") != s.fileName.length - 2) // if it does not endwith
                {
                    s.fileName += "[]";
                }
                fileInputStr = "<input type='file' id='" + fileUploadId + "' onclick='checkId(this)' name='" + s.fileName + "' multiple/>";
            }
