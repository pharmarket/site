...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-body">
                <table class="datatable table table-bordered table-striped" id="cgu-table" >
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Langue</th>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">CGU : {{$row->title}}</h4>
                                    </div>
                                    <div class="modal-body">
                                        <p>Vous êtes sur le point de supprimer définitivement la CGU : {{$row->title}}</p>
                                    </div>
                                    <div class="modal-footer">
                                        {!! Form::open(array('route' => array('admin.cgu.destroy', $row->id), 'method' => 'delete')) !!}
