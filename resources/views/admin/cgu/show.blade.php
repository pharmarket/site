...
<section class="content">
    <div class="row">
        <div class="col-md-6 col-md-offset-3 col-xs-12">
            <h3 style="text-align: center">Détails de la CGU n°{!! $cgu->id !!}</h3>
        </div><!-- /.col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 col-xs-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-9">{!! $cgu->langue->label !!}</div>
                    </div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 col-xs-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-9">{!! $cgu->title !!}</div>
                    </div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 col-xs-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-9">{!! $cgu->cgu !!}</div>
                    </div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        </div>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-9" style="font-size: 0.7em;">{!! $cgu->created_at !!}</div><br />
                        <div class="col-md-3" style="text-align: right; font-size: 0.7em;">Modifié le :</div>
                        <div class="col-md-9" style="font-size: 0.7em;">{!! $cgu->updated_at !!}</div>
                    </div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        </div>
