...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
		<meta charset="utf-8">
		<title>Commande - mirage</title>
		<meta name="generator" content="PrestaShop">
		<meta name="robots" content="index,follow">
		<meta name="viewport" content="width=device-width, minimum-scale=0.25, maximum-scale=1.6, initial-scale=1.0">
		<meta name="apple-mobile-web-app-capable" content="yes">
		<link rel="icon" type="image/vnd.microsoft.icon" href="http://localhost:8888/prestashop/img/favicon.ico?1324977642">
		<link rel="shortcut icon" type="image/x-icon" href="http://localhost:8888/prestashop/img/favicon.ico?1324977642">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/global.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/highdpi.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/responsive-tables.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/uniform.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/jquery.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/addresses.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockbanner.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockbestsellers.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockcart.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/jquery_003.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockcategories.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockcurrencies.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blocklanguages.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockcontact.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockmyaccount.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blocknewproducts.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blocknewsletter.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blocksearch.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/jquery_002.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockspecials.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blocktags.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockuserinfo.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blockviewed.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/homefeatured.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/hooks.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/blocktopmenu.css" type="text/css" media="all">
			<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/superfish-modified.css" type="text/css" media="all">
		<script type="text/javascript">
var CUSTOMIZE_TEXTFIELD = 1;
var CloseTxt = 'ENVOYER';
var FancyboxI18nClose = 'Fermer';
var FancyboxI18nNext = 'Suivant';
var FancyboxI18nPrev = 'Pr&eacute;c&eacute;dent';
var addressMultishippingUrl = 'http://localhost:8888/prestashop/adresse?back=order.php%3Fstep%3D1%26multi-shipping%3D1';
var addressUrl = 'http://localhost:8888/prestashop/adresse?back=order.php%3Fstep%3D1';
var addressUrlAdd = 'http://localhost:8888/prestashop/adresse?back=order.php%3Fstep%3D1&id_address=';
var ajax_allowed = true;
var ajaxsearch = true;
var baseDir = 'http://localhost:8888/prestashop/';
var baseUri = 'http://localhost:8888/prestashop/';
...
var formatedAddressFieldsValuesList = {"5":{"ordered_fields":["firstname lastname","company","vat_number","address1","address2","postcode city","Country:name","phone","phone_mobile"],"formated_fields_values":{"firstname":"Test","lastname":"test","company":"","vat_number":"","address1":"dfs","address2":"dfs","postcode":"99100","city":"pfmf","Country:name":"France","phone":"01001010000","phone_mobile":""}}};
var freeProductTranslation = 'Offert !';
var freeShippingTranslation = 'Livraison gratuite !';
var generated_date = 1427538159;
var hasDeliveryAddress = true;
var id_lang = 1;
var img_dir = 'http://localhost:8888/prestashop/themes/default-bootstrap/img/';
var instantsearch = false;
var isGuest = 0;
var isLogged = 1;
var isMobile = false;
var liUpdate = '<a class="button button-small btn btn-default" href="http://localhost:8888/prestashop/adresse?back=order.php%3Fstep%3D1&id_address=" title="Mettre à jour"><span>Mettre à jour<i class="icon-chevron-right right"></i></span></a>';
var opc = false;
...
var roundMode = 2;
var search_url = 'http://localhost:8888/prestashop/recherche';
var static_token = '1f7065c610135e396ad8a05ee4174399';
var titleDelivery = '<h3 class="page-subheading">Votre adresse de livraison</h3>';
var titleInvoice = '<h3 class="page-subheading">Votre adresse de facturation</h3>';
var toBeDetermined = 'À définir';
var token = '00a013ce4f45b5d2dc8f9016242a4167';
var txtProduct = 'produit';
var txtProducts = 'produits';
var usingSecureMode = false;
</script>

		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery-1.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery-migrate-1.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery_002.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/tools.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/global.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/10-bootstrap.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/15-jquery_002.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/15-jquery.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery_004.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/products-comparison.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/order-address.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/ajax-cart.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery_006.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery_003.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/treeManagement.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/blocknewsletter.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/jquery_005.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/blocksearch.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/hoverIntent.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/superfish-modified.js"></script>
		<script type="text/javascript" src="adresse%20-%20mirage_fichiers/blocktopmenu.js"></script>
			
		<link rel="stylesheet" href="adresse%20-%20mirage_fichiers/css.css" type="text/css" media="all">
		<!--[if IE 8]>
			...
			<div class="header-container">
				<header id="header">
					<div class="banner">
						<div class="container">
							<div class="row">
								<a href="http://localhost:8888/prestashop/" title="">
	<img class="img-responsive" src="adresse%20-%20mirage_fichiers/sale70.png" alt="" title="" height="65" width="1170">
</a>
	...
	<div class="header_user_info">
		<a href="http://localhost:8888/prestashop/mon-compte" title="Voir mon compte client" class="account" rel="nofollow"><span>Test test</span></a>
	</div>
<div class="header_user_info">
			<a class="logout" href="http://localhost:8888/prestashop/?mylogout=" rel="nofollow" title="Me déconnecter">
			Déconnexion
		</a>
	</div>
<!-- /Block usmodule NAV -->
...
<!-- /Block languages module -->
<div id="contact-link">
	<a href="http://localhost:8888/prestashop/nous-contacter" title="Contactez-nous">Contactez-nous</a>
</div>
		...
		<i class="icon-phone"></i>Appelez-nous au : <strong>0123-456-789</strong>
					...
					<div>
						<div class="container">
							<div class="row">
								<div id="header_logo">
									<a href="http://localhost:8888/prestashop/" title="mirage">
										<img class="logo img-responsive" src="adresse%20-%20mirage_fichiers/logo.jpg" alt="mirage" height="99" width="350">
									</a>
								</div>
...
<div id="search_block_top" class="col-sm-4 clearfix">
	<form id="searchbox" method="get" action="//localhost:8888/prestashop/recherche">
		...
		<input autocomplete="off" class="search_query form-control ac_input" id="search_query_top" name="search_query" placeholder="Rechercher" type="text">
...
<div class="col-sm-4 clearfix">
	<div class="shopping_cart">
		<a href="http://localhost:8888/prestashop/commande" title="Voir mon panier" rel="nofollow">
			<b>Panier</b>
			...
			<span class="ajax_cart_no_product unvisible">(vide)</span>
				...
				<div class="block_content">
					...
					<div class="cart_block_list">
										...
										<a class="cart-images" href="http://localhost:8888/prestashop/robes-decontractees/3-robe-imprimee.html" title="Robe imprimée"><img src="adresse%20-%20mirage_fichiers/robe-imprimee.jpg" alt="Robe imprimée"></a>
										<div class="cart-info">
											<div class="product-name">
												<span class="quantity-formated"><span class="quantity">1</span>&nbsp;x&nbsp;</span><a class="cart_block_product_name" href="http://localhost:8888/prestashop/robes-decontractees/3-robe-imprimee.html#/taille-s/couleur-orange" title="Robe imprimée">Robe imprimée</a>
											</div>
																							<div class="product-atributes">
													<a href="http://localhost:8888/prestashop/robes-decontractees/3-robe-imprimee.html#/taille-s/couleur-orange" title="Détails de l'article">S, Orange</a>
												</div>
																						<span class="price">
																									31,20 €																							</span>
										</div>
										<span class="remove_link">
																							<a class="ajax_cart_block_remove_link" href="http://localhost:8888/prestashop/panier?delete=1&amp;id_product=3&amp;ipa=13&amp;id_address_delivery=0&amp;token=1f7065c610135e396ad8a05ee4174399" rel="nofollow" title="supprimer cet article du panier">&nbsp;</a>
																					</span>
									</dt>
																			<dd data-id="cart_block_combination_of_3_13_0" class="first_item">
																		<!-- Customizable datas -->
																		</dd>															</dl>
							...
							<div class="cart-prices-line first-line">
								...
								<span class="price cart_block_total ajax_block_cart_total">31,20 €</span>
								<span>Total</span>
							</div>
													</div>
						<p class="cart-buttons">
							<a id="button_order_cart" class="btn btn-default button button-small" href="http://localhost:8888/prestashop/commande" title="Commander" rel="nofollow">
								<span>
